...
This document is a **working skeleton**, not a final policy. What we know for
certain about this website is written below; anything that depends on a decision
not yet made is marked with double brackets.
...
This website is static and does not build browsing profiles. The only data we
hold is what you type into a form:
